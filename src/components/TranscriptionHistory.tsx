...
import { ChevronDown, ChevronUp, Clock, FileAudio, Trash2 } from "lucide-react";
          ...
          >
            ...
            {expanded === item.id && (
              <div
                dir="rtl"
                lang="yi"
                className="px-5 pb-5 pt-2 text-stone-700 text-base leading-[1.8] font-hebrew border-t border-stone-100 animate-fade-in"
              >
                {item.transcription}
              </div>
            )}
